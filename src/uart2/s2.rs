...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LBKDER {
    #[doc = "Break character is detected at length of 10 bit times (C1\\[M\\] = 0), 11 (C1\\[M\\] = 1 and C4\\[M10\\] = 0), or 12 (C1\\[M\\] = 1, C4\\[M10\\] = 1, and S1\\[PE\\] = 1)."]
    _0,
    #[doc = "Break character is detected at length of 11 bits times (if C1\\[M\\] = 0 or 12 bits time (if C1\\[M\\] = 1)."]
    _1,
}
impl LBKDER {
    #[doc = r" Returns `true` if the bit is clear (0)"]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RWUIDR {
    #[doc = "The S1\\[IDLE\\] bit is not set upon detection of an idle character."]
    _0,
    #[doc = "The S1\\[IDLE\\] bit is set upon detection of an idle character."]
    _1,
}
impl RWUIDR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
