...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PCSSER {
    #[doc = "PCS\\[5\\]/PCSS is used as the Peripheral Chip Select\\[5\\] signal."]
    _0,
...
#[doc = "Values that can be written to the field `DCONF`"]
pub enum DCONFW {
    #[doc = "SPI"]
    _00,
    #[doc = "Reserved"]
...
#[doc = r" Proxy"]
pub struct _DCONFW<'a> {
    w: &'a mut W,
}
impl<'a> _DCONFW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: DCONFW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _00(self) -> &'a mut W {
        self.variant(DCONFW::_00)
    }
    #[doc = "Reserved"]
    #[inline]
    pub fn _01(self) -> &'a mut W {
        self.variant(DCONFW::_01)
    }
    #[doc = "Reserved"]
    #[inline]
    pub fn _10(self) -> &'a mut W {
        self.variant(DCONFW::_10)
    }
    #[doc = "Reserved"]
    #[inline]
    pub fn _11(self) -> &'a mut W {
        self.variant(DCONFW::_11)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub fn bits(self, value: u8) -> &'a mut W {
