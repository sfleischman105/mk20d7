...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LKR {
    #[doc = "Pin Control Register bits \\[15:0\\] are not locked."]
    _0,
    #[doc = "Pin Control Register bits \\[15:0\\] are locked and cannot be updated until the next System Reset."]
    _1,
}
impl LKR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
