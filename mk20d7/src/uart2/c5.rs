...
pub enum RDMASR {
    #[doc = "If C2\\[RIE\\] is set and the S1\\[RDRF\\] flag is set, the RDFR interrupt request signal is asserted to request interrupt service."]
    _0,
    #[doc = "If C2\\[RIE\\] is set and the S1\\[RDRF\\] flag is set, the RDRF DMA request signal is asserted to request a DMA transfer."]
    _1,
}
impl RDMASR {
